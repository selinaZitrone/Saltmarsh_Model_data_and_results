...
def write_xml_file(filepath, salinity_id, replicate, group_count=4):
    ...
    ET.SubElement(bg, "salinity").text = f"{salinity}.csv"
    ...
    for i in range(1, group_count + 1):
        ...
        ET.SubElement(group, "name").text = f"Saltmarsh_{i}"
        ET.SubElement(group, "species").text = f"../data_and_results/input_files/species/Saltmarsh_{i}.py"
        ...
        ET.SubElement(dist, "n_recruitment_per_step").text = "4"
        ET.SubElement(dist, "n_individuals").text = "40"
    ...
    ET.SubElement(output, "output_dir").text = f"../data_and_results/data_raw/community/dynamic/{salinity_id}/{replicate:02d}"
...
# === MAIN LOOP ===
setup_name = "community_dynamic"

for salinity in ['C:/Users/Jonas/Documents/MASCOT/SourceCode/data_and_results/input_files/salinity/35_V1',
                 'C:/Users/Jonas/Documents/MASCOT/SourceCode/data_and_results/input_files/salinity/35_V2',
                 'C:/Users/Jonas/Documents/MASCOT/SourceCode/data_and_results/input_files/salinity/70_V1',
                 'C:/Users/Jonas/Documents/MASCOT/SourceCode/data_and_results/input_files/salinity/70_V2',
                 'C:/Users/Jonas/Documents/MASCOT/SourceCode/data_and_results/input_files/salinity/105_V1',
                 'C:/Users/Jonas/Documents/MASCOT/SourceCode/data_and_results/input_files/salinity/105_V2']:
    salinity_id = os.path.basename(salinity)
    for n in range(1, 11):
        xml_filename = f"../xml_control_files/{setup_name}_{salinity_id}_{n:02d}.xml"
        os.makedirs(f"../data_raw/community/dynamic/{salinity_id}/{n:02d}",
                    exist_ok=True)
        write_xml_file(xml_filename, salinity_id=salinity_id, replicate=n)
